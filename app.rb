...
# I had to modify the existing code according to a previous reviewer's suggestion.
Product.new("LEGO Iron Man vs. Ultron", price: 22.99, stock: 55)
Product.new("Nano Block Empire State Building", price: 49.99, stock: 12)
Product.new("LEGO Firehouse Headquarter", price: 199.99, stock: 0)
